...
from notify_monitor import config, state_lookup
from notify_monitor.publisher import RedisPublisher
...
def test_maybe_push_enqueues_mapped_scenario(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("notify_monitor.db.get_setting", lambda _k, d=None: d)
