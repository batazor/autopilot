...
# the wiki stack serves heroes, items, pets and experts. Pets and experts ship as
# per-game core catalogs under games/<game>/db/<entity>/ (same index + per-entity
# YAML layout).
EntityKey = Literal["heroes", "items", "pets", "experts"]
