...
# Last New screenshot capture: temporal rel under references/ + detector screen_id (applied on basename promote).
LABELING_CAPTURE_SCREEN_ID_REL = "labeling_capture_screen_id_rel"
LABELING_CAPTURE_SCREEN_ID_VALUE = "labeling_capture_screen_id_value"
...
LABELING_AREA_DIRTY = "labeling_area_dirty"
