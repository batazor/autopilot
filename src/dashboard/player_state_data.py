...
def build_persisted_player_view(g: GamerState) -> dict[str, Any]:
    ...
    return {
        ...
        "troops": {
            ...
            "infantry_remaining_s": g.troops.infantry.state.training_remaining_s,
            "lancer_remaining_s": g.troops.lancer.state.training_remaining_s,
            "marksman_remaining_s": g.troops.marksman.state.training_remaining_s,
            "infantry_ends_at": g.troops.infantry.state.training_ends_at,
            "lancer_ends_at": g.troops.lancer.state.training_ends_at,
            "marksman_ends_at": g.troops.marksman.state.training_ends_at,
        },
        "marches": g.marches.model_dump(mode="json"),
        "alliance_block": {
            "alliance": g.alliance.name or "—",
            "alliance_power": g.alliance.power,
