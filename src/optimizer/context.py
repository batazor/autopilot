...
Values come from :mod:`config.balance._data` (Python constants). The legacy
``config/balance/*.yaml`` files were folded into that module so the priors
live in one place — see the module docstring for details.
"""
