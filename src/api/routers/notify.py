...
Reuses the standalone :mod:`modules.notify` package (SQLite data layer, dumpsys
...
from modules.notify import config as nm_config
from modules.notify import db as nm_db
