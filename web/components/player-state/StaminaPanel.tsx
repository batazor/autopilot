  ...
  return (
    <div>
      ...
      <MetricGrid className="mb-4">
        <MetricCard label="Regen" value={`${regen_per_hour}/h`} />
        <MetricCard label="Caps in" value={fmtDuration(seconds_to_cap)} />
        <MetricCard label="Last read" value={fmtAge(stamina.stamina_read_at)} />
      </MetricGrid>
