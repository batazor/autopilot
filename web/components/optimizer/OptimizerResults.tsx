...
export function OptimizerResults({
  ...
  return (
    <>
      <MetricGrid>
        <MetricCard label="Solver" value={m.status} />
        <MetricCard label="Objective" value={m.objective.toLocaleString()} />
        <MetricCard label="Selected" value={m.selected_count} />
        <MetricCard label="Rejected" value={m.rejected_count} />
        <MetricCard label="Pruned" value={m.pruned_count} />
        <MetricCard label="Profile" value={m.profile_id || "(none)"} />
      </MetricGrid>
