...
export function QueueMetrics({ data }: { data: QueueView | null }) {
  ...
  return (
    <MetricGrid>
      <MetricCard label="Pending" value={s.pending} />
      <MetricCard label="Overdue" value={s.overdue} tone={s.overdue ? "warn" : "neutral"} />
      <MetricCard label="Running" value={s.running} tone={s.running ? "accent" : "neutral"} />
      <MetricCard label="Recent OK" value={s.ok} tone="ok" />
      <MetricCard label="Recent failed" value={s.fail} tone={s.fail ? "danger" : "neutral"} />
    </MetricGrid>
  );
}
