...
from games.wos.events.dreamscape_memory.solver.constants import (
    _DEFAULT_BATCH_REOPEN_OCR_PROBE_ITERS,
    _DEFAULT_FUZZ_AMBIGUITY_MARGIN,
    _DEFAULT_FUZZ_THRESHOLD,
    _DEFAULT_HELP_CAPTURE_DELAY_S,
    _DEFAULT_HELP_COUNT,
    _DEFAULT_HELP_COUNTER_REGION,
    _DEFAULT_HELP_DIFF_GAP_S,
    _DEFAULT_HELP_REGION,
    _DEFAULT_LOOP_MAX_ITERATIONS,
    _DEFAULT_LOOP_TTL_S,
    _DEFAULT_LOOP_WAIT_S,
    _DEFAULT_MAX_TAP_ATTEMPTS,
    _DEFAULT_MULTIPLAYER_REGIONS,
    _DEFAULT_REGIONS,
    _DEFAULT_START_GATE_WAIT_S,
    ...
    _SLOT_HELP_REQUESTED,
    _SLOT_MAPPED,
    _SLOT_RETRY_EXHAUSTED,
    _SLOT_SETTLED,
    _SLOT_TAP_REJECTED,
    _SLOT_UNKNOWN,
    _SLOT_UNMAPPED,
    _SLUG_SUFFIX_RE,
    _START_GATE_BRIGHT_THRESHOLD,
    _START_GATE_MIN_BRIGHT_PX,
    _START_GATE_MIN_LIT_SLOTS,
    _START_SCREEN,
    _TERMINAL_ALL_FOUND,
    _TERMINAL_SCREENS,
    _TERMINAL_TIME_UP,
