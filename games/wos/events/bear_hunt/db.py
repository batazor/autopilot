...
Lives in the shared encrypted ``state.db`` (SQLCipher) alongside the other
alliance tables (``alliance_daily`` / ``alliance_members``), wired through
:mod:`config.orm` exactly like :mod:`games.wos.core.calendar.db`.
