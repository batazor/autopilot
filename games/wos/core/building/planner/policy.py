...
something useful instead — a resource producer or a Shelter (worker housing).
...
# Economy / combat building base weights (before the role multiplier).
CATEGORY_WEIGHT = {"producer": 55.0, "shelter": 50.0, "camp": 60.0}

# Which role category each building kind biases with.
KIND_ROLE_CATEGORY = {"producer": "economy", "shelter": "economy", "camp": "battle"}
